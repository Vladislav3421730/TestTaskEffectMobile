...
import com.example.testtaskeffectmobile.repository.CustomCardRepository;
...
public class CardServiceImpl implements CardService {
    ...
    @Override
    public Page<CardDto> findAll(PageRequest pageRequest, BigDecimal minBalance, BigDecimal maxBalance, LocalDate expiredBefore, LocalDate expiredAfter) {
        return customCardRepository.findByFilters(minBalance, maxBalance, expiredBefore, expiredAfter, pageRequest)
